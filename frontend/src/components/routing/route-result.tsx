...
export function RouteResult({ route, onViewDetail }: { route: BaseRoute; onViewDetail?: (route: BaseRoute) => void }) {
  return <Card className="space-y-4 p-4">
    ...
    <p className="text-sm leading-5 text-[var(--color-muted)]">Rute ditampilkan sebagai satu garis biru pada peta. Safety Score tersedia terpisah pada informasi stasiun.</p>
